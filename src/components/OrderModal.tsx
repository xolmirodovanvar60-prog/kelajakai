...
import { X, FileText, ClipboardList, Handshake } from "lucide-react";
...
const serviceCards = [
  {
    icon: FileText,
    title: "Sud hujjatlari",
    description: "Da'vo arizalari, shikoyatlar, sudga oid hujjatlar"
  },
  {
    icon: ClipboardList,
    title: "Arizalar",
    description: "Rasmiy ariza, murojaat va iltimosnomalar"
  },
  {
    icon: Handshake,
    title: "Shartnomalar",
    description: "Ijara, xizmat ko'rsatish va hamkorlik shartnomalari"
  }
];
            ...
            >
              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-10">
                ...
                <div className="text-center mb-10">
                  ...
                  >
                    Sun'iy intellekt yordamida tayyorlanadi
                  </motion.p>
                </div>
                ...
                >
                  Barcha hujjatlar professional darajada tayyorlanadi
                </motion.p>
              </div>
            </motion.div>
          </div>
